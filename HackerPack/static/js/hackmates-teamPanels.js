...
function createTeamPanel() {
    ...
    var html_teammember_frameworks = '<p> <b> Frameworks: </b> ' + teammember_frameworks + '</p>';
    var html_teammember_ideas = '<p> <b> Hackthon Ideas: </b> ' + teammember_ideas + '</p>';
    var html_teammember_languages = '<p> <b> Languages: </b> ' + teammember_languages.toString() + '</p>';
    var html_teammember_roles = '<p> <b> Roles: </b> ' + teammember_roles.toString() + '</p>';
    ...
    var tempString = "<div class='col-md-4'" + ">" +
        ...
        teammember_html_fb_link + html_teammember_hackathons + html_teammember_school
